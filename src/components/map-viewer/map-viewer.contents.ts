...
export const locationData: Record<'portland' | 'paloAlto' | 'nyc' | 'schenectady', PointOfInterest> =
  {
    ...
    nyc: {
      ...
      title: 'New York City',
      description:
        'On the lookout for my next challenge in New York City, where I can apply my expertise in React, TypeScript, and frontend development to build innovative, seamless user experiences. Working on my next big idea in the meantime',
