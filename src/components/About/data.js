export const items = [
  ...
  },
  {
    id: "tumblr",
      ...
      blurb: "During high school, I had the opportunity to spend two weeks interning with the systems department at Tumblr at their NYC headquarters. Those weeks, paired with an already acute interest in tech, provided a reference point for the type of work the field entails. The teamwork, atmosphere, and community they've cultivated at Tumblr became a core motivator as I realized my desire to be part of building the complex digital landscape that enables our quality of life in modern society. ^As a high school student with minimal production-ready skills, I wasn’t given any mission-critical tasks. Nevertheless, I was able to dip my toes into Ruby, HTML, and CSS under the watchful supervision of professionals and see firsthand that a career in tech is for me.",
    ...
    },
    {
      ...
      blurb: "The PHS robotics team was founded in 2013 following a generous donation of equipment from Bank of America. During our first season, we were fortunate to qualify for the VEX Robotics World Championship in Los Angeles during the Maine State championships. Determined to compete despite our lack of previous experience, we set our sights on the championship, oiled our bearings, tightened loose bolts, and debugged code. ^Enabled by a generous donation from Boston's Koa Labs we packed up and shipped out across the U.S. to test our skills. Although we weren't able to secure the world champion title, the atmosphere surrounding the competition was palpable. My peers' and competitors' dedication and excitement showed me that tech is much more than long nights and frustrating problems. It’s that too, but more importantly, it’s the exhilaration of watching countless hours come together in concert to accomplish seemingly impossible tasks and lifting my fellow creators up to make something bigger and more wonderful than I could ever imagine alone.",
    ...
    },
    {
      ...
      },
      {
        ...
        blurb: "2DineIn has become an integral part of Portland Maine’s restaurant scene in recent years. Competing against heavy-hitters such as Uber Eats and GrubHub, 2DineIn rose above the competition by maintaining a local mindset to rapid delivery. Based out of southern Maine, 2DineIn only serves the greater Portland area, allowing it to maintain a more personal relationship with both its clients and customers. Enabled by cutting-edge fleet technology, 2DineIn combines the indispensable knowledge of skilled dispatchers with tracking data to deliver unrivaled delivery service in Portland.^While working for 2DineIn I was consistently surprised by how effectively their blend of human and computer intelligence enabled me as a driver. Having worked for a competitor on and off for a short period of time, It was clear that some parts of local knowledge were nearly impossible to emulate with software. 2DineIn dispatchers could see the big picture for me and would regularly have me delivering multiple different restaurants’ food to similar locations simultaneously, boosting my profits beyond anything I had seen working on and off with their competitors.",
      ...
      },
      {
        ...
        blurb: "Local 188 is a vibrant, Spanish-inspired restaurant in the heart of Portland Maine. The open kitchen layout puts patrons front and center as cooks assemble elegant plates of local ingredients into seasonal tapas and seafood at night and decadent brunches by day.^During high school, I landed my first line cooking job working brunch shifts on weekends. Although my fundamentals were solid, the fast pace at Local 188 was overwhelming at first, but I quickly began to love it. As my responsibilities grew I pushed my attention span to new limits, managing tens of orders as I balanced quality, speed, and timing on the fly.",
